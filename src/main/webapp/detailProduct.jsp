                        ...
                        <div class="table-responsive mb-2">
                            <table class="table table-sm table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td class="pb-0">Select phone memory</td>
                                </tr>
                                <tr>
                                    <td class="pl-0">
                                        <div class="mt-1">
                                    ...
                                    <td>
                                        <div class="mt-1">
                                            <div class="form-check form-check-inline pl-0">
                                                <input type="radio" class="form-check-input" id="small" value="128GB"
                                                       name="size" checked>
                                                <label class="form-check-label small text-uppercase card-link-secondary"
                                                       for="small">128GB</label>
                                            </div>
                                            <div class="form-check form-check-inline pl-0">
                                                <input type="radio" class="form-check-input" id="medium" value="256GB"
                                                       name="size">
                                                <label class="form-check-label small text-uppercase card-link-secondary"
                                                       for="medium">256GB</label>
                                            </div>
                                            <div class="form-check form-check-inline pl-0">
                                                <input type="radio" class="form-check-input" id="large" value="512GB"
                                                       name="size">
                                                <label class="form-check-label small text-uppercase card-link-secondary"
                    ...
                    <div class="col-md-6 col-lg-3 mb-5">
                        ...
                        <div class="">
                            ...
                            <div class="view zoom overlay z-depth-2 rounded">
                                ...
                                <h4 class="mb-0"><span class="badge badge-primary badge-pill badge-news">Sale 10%</span>
                                </h4>
                            ...
                            <div class="pt-4">
                                ...
                                <h5>${o.title }</h5>
                                <p><span
                                        class="text-danger mr-1"><strong>${String.format("%.02f",o.price*0.9) }$</strong></span><span
