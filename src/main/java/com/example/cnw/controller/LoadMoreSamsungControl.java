...
@WebServlet(name = "LoadMoreSamsungControl", urlPatterns = {"/loadSamsung"})
public class LoadMoreSamsungControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = productDAO.getNext4NikeProduct(iamount);
        PrintWriter out = response.getWriter();

        for (Product o : list) {
            out.println("<div class=\"productSamsung col-12 col-md-6 col-lg-3\">\r\n"
            		+ "                                <div class=\"card\">\r\n"
