...
import com.example.cnw.dao.SoLuongDaBanDAO;
...
public class XuatExcelTop10ProductControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<SoLuongDaBan> listTop10Product = soLuongDaBanDAO.getTop10SanPhamBanChay();
        ...
        FileOutputStream file = new FileOutputStream("/Users/thanhviet/ExcelPhone/" + "top-10-san-pham" + Integer.toString(randomNum) + ".xlsx");
