...
public class XuatExcelTop5EmployeeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<TongChiTieuBanHang> listTop5NhanVien = tongChiTieuBanHangDAO.getTop5NhanVien();
        ...
        FileOutputStream file = new FileOutputStream("/Users/thanhviet/ExcelPhone/" + "top-5-nhan-vien" + Integer.toString(randomNum) + ".xlsx");
