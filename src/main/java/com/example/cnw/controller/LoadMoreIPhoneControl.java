...
@WebServlet(name = "LoadMoreIPhoneControl", urlPatterns = {"/loadIPhone"})
public class LoadMoreIPhoneControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = productDAO.getNext4IPhoneProduct(iamount);
        PrintWriter out = response.getWriter();

        for (Product o : list) {
            out.println(" <div class=\"productIPhone col-12 col-md-6 col-lg-3\">\r\n"
            		+ "                                <div class=\"card\">\r\n"
