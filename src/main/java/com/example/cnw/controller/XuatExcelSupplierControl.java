...
import com.example.cnw.dao.SupplierDAO;
...
public class XuatExcelSupplierControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FileOutputStream file = new FileOutputStream("/Users/thanhviet/ExcelPhone/" + "nha-cung-cap" + Integer.toString(randomNum) + ".xlsx");
